...
public class MiniControllerServer<TChatRoom> {
	...
	public MiniControllerServer(IChatRoom chatRoom, IUser user, ServerView<TChatRoom> serverView, ServerModel serverModel) {
		...
		crMiniModel = new ChatRoomMiniModel(chatRoom, receiver, new IMiniModelToMiniViewAdapter() {
			...
			public void exitChatRoom(IChatRoom chatRoom) {
				// TODO Auto-generated method stub
				// serverModel.exitChatRoom(chatRoom);
		...
		serverView.addChatRoomTab(crMiniView);
	}
}
